 ...
 */
public class Vector2DataEditor extends AbstractDataEditor<Vector2Data>
{
	@AttributeDL(required = true)	
	protected Vector2Data data;
	...
	@Override
	public Vector2Data getData()
	{
		return data;
	}

	@Override
	public void setData(Vector2Data data)
	{
		this.data = data;
	}
}
